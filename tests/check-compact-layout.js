...
const requiredSnippets = [
  ...
  ["卡塔尔 1-1 瑞士", "B group should record Qatar 1-1 Switzerland"],
  ["巴西 1-1 摩洛哥", "C group should record Brazil 1-1 Morocco"],
  ["海地 0-1 苏格兰", "C group should record Haiti 0-1 Scotland"],
  ["美国 4-1 巴拉圭", "D group should record USA 4-1 Paraguay"],
  ["澳大利亚 2-0 土耳其", "D group should record Australia 2-0 Turkey"],
  ["C 组积分", "standings snapshot should show Group C after Brazil Morocco"],
  ...
  ["北京时间 06-14 13:21", "score panel timestamp should use explicit Beijing time instead of CST"],
  ["06-14 12:00 北京", "completed fixture cards should keep Beijing kickoff time visible"],
  ["hero-insights", "hero should use the open space for schedule and standings insight panels"],
  ["今日赛况", "hero insight panel should summarize today's completed fixtures"],
